...
![](wangweichao0403.github.io/img/linxuetian/Lecture 1 The Learning Problem/01.png)

机器学习可以被定义为：Improving some performance measure with experence computed from data. 也就是机器从数据中总结经验，从数据中找出某种规律或者模型，并用它来解决实际问题。

![](wangweichao0403.github.io/img/linxuetian/Lecture 1 The Learning Problem/02.png)
...
有大量的数据样本可供使用
![](wangweichao0403.github.io/img/linxuetian/Lecture 1 The Learning Problem/03.png)
...
![](wangweichao0403.github.io/img/linxuetian/Lecture 1 The Learning Problem/04.png)

实际中，机器学习的流程图可以表示为：
![](wangweichao0403.github.io/img/linxuetian/Lecture 1 The Learning Problem/05.png)
...
**统计**（Statistics）
![](wangweichao0403.github.io/img/linxuetian/Lecture 1 The Learning Problem/06.png)
![](wangweichao0403.github.io/img/linxuetian/Lecture 1 The Learning Problem/07.png)
